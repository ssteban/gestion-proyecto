document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("ver-usuarios").addEventListener("click", function(event) {
        event.preventDefault();
        loadContent('ver-usuarios.html', function() {
            loadScript('/static/js/ver-usuarios.js', function() {
                console.log('Script de ver-usuarios.js cargado y ejecutado.');
            });
        });
    });
